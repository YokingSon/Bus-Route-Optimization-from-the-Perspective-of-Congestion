...
part_n=5
f=open('TrafficStatus_XY2.txt','a',encoding='utf-8')
f2=open('TrafficStatus2.txt','a',encoding='utf-8')
count=0
num=0
url0='http://restapi.amap.com/v3/traffic/status/rectangle?level=2&rectangle='
